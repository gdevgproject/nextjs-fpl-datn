    ...
    <div className="flex flex-col space-y-4 text-center">
      ...
      {status === "loading" && (
        <div className="flex flex-col items-center justify-center space-y-4">
          ...
          <p className="text-sm text-muted-foreground">Đang xác nhận email của bạn...</p>
        </div>
      )}
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Email của bạn đã được xác nhận. Bạn sẽ được chuyển hướng đến trang đăng nhập trong vài giây.
            </p>
          </div>
          <Button asChild>
            <Link href="/dang-nhap?auth_action=email_confirmed">Đến trang đăng nhập</Link>
          </Button>
        </div>
      )}
      ...
      {status === "error" && (
        <div className="space-y-4">
          ...
          <Alert variant="destructive">
            ...
            <AlertDescription>
              {errorMessage || "Liên kết xác nhận không hợp lệ hoặc đã hết hạn. Vui lòng thử lại."}
            </AlertDescription>
          </Alert>
