...
const genderFormSchema = z.object({
  name: z
    .string()
    .min(1, "Tên giới tính không được để trống")
    .max(50, "Tên giới tính không được vượt quá 50 ký tự"),
});
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>
            {mode === "create" ? "Thêm giới tính mới" : "Chỉnh sửa giới tính"}
          </DialogTitle>
          <DialogDescription>
            {mode === "create"
              ? "Thêm một giới tính mới vào hệ thống."
              : "Chỉnh sửa thông tin giới tính."}
          </DialogDescription>
        </DialogHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Tên giới tính phải là duy nhất trong hệ thống.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
