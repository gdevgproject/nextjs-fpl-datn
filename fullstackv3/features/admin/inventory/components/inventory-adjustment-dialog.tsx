    ...
    >
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Thêm hoặc bớt số lượng sản phẩm trong kho. Số dương để nhập kho, số
            âm để xuất kho.
          </DialogDescription>
        </DialogHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                    ...
                    <SelectContent>
                      ...
                      {variants.length === 0 ? (
                        ...
                        variants.map((variant: any) => (
                          ...
                          >
                            {variant.products?.name} - {variant.volume_ml}ml (
                            {variant.sku})
                          </SelectItem>
                        ))
                      )}
                  ...
                  <FormDescription>
                    Chọn biến thể sản phẩm cần điều chỉnh kho
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            {selectedVariant && (
              <div className="p-3 bg-muted rounded-md text-sm">
                ...
                <p>
                  ...
                  {selectedVariant.products?.brands?.name}
                </p>
              </div>
            )}
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      type="number"
                      placeholder="Nhập số lượng (dương để nhập, âm để xuất)"
                      {...field}
                    />
                  </FormControl>
                  <FormDescription>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Mô tả lý do điều chỉnh kho (ví dụ: Nhập hàng mới, Kiểm kê,
                    Hàng lỗi...)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
