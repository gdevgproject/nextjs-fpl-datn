...
import { OrderConfirmationClient } from "@/features/shop/orders/components/order-confirmation-client";
...
async function getOrderServerSide(
  ...
  const { getOrderDetails } = await import("@/features/shop/orders/actions");
