    ...
    <section className="rounded-lg bg-primary-5 p-3 sm:p-4" aria-labelledby="deals-heading">
      <header className="mb-3 sm:mb-4 flex items-center justify-between">
        <div className="flex items-center gap-2 sm:gap-4">
          <h2 id="deals-heading" className="flex items-center gap-1 sm:gap-2 text-lg sm:text-xl font-bold text-white">
            Săn
            <span className="text-warning-5">⚡</span>
            Deal
          </h2>
          <div className="flex gap-1 sm:gap-2 text-white text-xs sm:text-sm" aria-label="Thời gian còn lại">
            ...
            <article className="rounded-lg bg-white p-2 sm:p-4">
              ...
              <div className="mb-1 sm:mb-2">
                <div className="flex items-center gap-1">
                  <span className="text-base sm:text-lg font-bold text-primary-5">{deal.salePrice}</span>
                  <span className="text-xs sm:text-sm text-grayscale-50">/{deal.unit}</span>
                </div>
                <p className="text-xs sm:text-sm text-grayscale-40 line-through">{deal.originalPrice}</p>
              </div>
