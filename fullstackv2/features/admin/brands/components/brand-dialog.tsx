...
export function BrandDialog({ open, onOpenChange, mode, brand }: BrandDialogProps) {
  ...
  const onSubmit = async (values: BrandFormValues) => {
    try {
      ...
      if (mode === "create") {
        ...
        const newBrandId = Array.isArray(result) && result.length > 0 ? result[0].id : null
        ...
        if (logoFile && newBrandId) {
          try {
            ...
            toast.error(
              `Thương hiệu đã được tạo nhưng tải lên logo thất bại: ${error instanceof Error ? error.message : "Unknown error"}`,
            )
          }
        }
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>{mode === "create" ? "Thêm thương hiệu mới" : "Chỉnh sửa thương hiệu"}</DialogTitle>
          <DialogDescription>
            {mode === "create" ? "Thêm một thương hiệu mới vào hệ thống." : "Chỉnh sửa thông tin thương hiệu."}
          </DialogDescription>
        </DialogHeader>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Tên thương hiệu phải là duy nhất trong hệ thống.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Mô tả ngắn gọn về thương hiệu.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Tải lên logo của thương hiệu. Hỗ trợ định dạng PNG, JPG, GIF, WEBP và SVG.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={isProcessing}>
                {isProcessing ? "Đang xử lý..." : mode === "create" ? "Tạo thương hiệu" : "Cập nhật thương hiệu"}
              </Button>
            </DialogFooter>
          </form>
        </Form>
