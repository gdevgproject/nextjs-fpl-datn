...
export function PerfumeTypeDialog({ open, onOpenChange, mode, perfumeType }: PerfumeTypeDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>{mode === "create" ? "Thêm loại nước hoa mới" : "Chỉnh sửa loại nước hoa"}</DialogTitle>
          <DialogDescription>
            {mode === "create" ? "Thêm một loại nước hoa mới vào hệ thống." : "Chỉnh sửa thông tin loại nước hoa."}
          </DialogDescription>
        </DialogHeader>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Tên loại nước hoa phải là duy nhất trong hệ thống.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={isProcessing}>
                {isProcessing ? "Đang xử lý..." : mode === "create" ? "Tạo loại nước hoa" : "Cập nhật loại nước hoa"}
              </Button>
            </DialogFooter>
          </form>
        </Form>
