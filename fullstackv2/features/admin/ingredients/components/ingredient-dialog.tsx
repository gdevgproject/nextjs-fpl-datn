...
export function IngredientDialog({ open, onOpenChange, mode, ingredient }: IngredientDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>{mode === "create" ? "Thêm thành phần mới" : "Chỉnh sửa thành phần"}</DialogTitle>
          <DialogDescription>
            {mode === "create" ? "Thêm một thành phần mới vào hệ thống." : "Chỉnh sửa thông tin thành phần."}
          </DialogDescription>
        </DialogHeader>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Tên thành phần phải là duy nhất trong hệ thống.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={isProcessing}>
                {isProcessing ? "Đang xử lý..." : mode === "create" ? "Tạo thành phần" : "Cập nhật thành phần"}
              </Button>
            </DialogFooter>
          </form>
        </Form>
