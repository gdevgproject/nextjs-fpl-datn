...
export function BannerImageUploader({ initialImageUrl, bannerId, onChange }: BannerImageUploaderProps) {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        ...
        {previewUrl ? (
          <>
            <Image src={previewUrl || "/placeholder.svg"} alt="Banner preview" fill className="object-contain p-2" />
            <Button
              type="button"
              variant="destructive"
              size="icon"
          ...
          <div className="flex flex-col items-center justify-center text-muted-foreground p-4">
            ...
            <p className="text-xs text-center mt-1">Nhấn nút bên dưới để tải lên</p>
          </div>
        )}
      </div>
