...
const productFormSchema = z.object({
  name: z.string().min(1, "Tên sản phẩm không được để trống").max(255, "Tên sản phẩm không được vượt quá 255 ký tự"),
  product_code: z.string().max(100, "Mã sản phẩm không được vượt quá 100 ký tự").optional().nullable(),
  short_description: z.string().max(500, "Mô tả ngắn không được vượt quá 500 ký tự").optional().nullable(),
  long_description: z.string().max(5000, "Mô tả chi tiết không được vượt quá 5000 ký tự").optional().nullable(),
  ...
  origin_country: z.string().max(100, "Xuất xứ không được vượt quá 100 ký tự").optional().nullable(),
  release_year: z
    .string()
    .refine((val) => !val || (Number.parseInt(val) >= 1800 && Number.parseInt(val) <= new Date().getFullYear()), {
      message: `Năm phát hành phải từ 1800 đến ${new Date().getFullYear()}`,
    })
    .optional()
    .nullable(),
  style: z.string().max(100, "Phong cách không được vượt quá 100 ký tự").optional().nullable(),
  sillage: z.string().max(100, "Độ tỏa hương không được vượt quá 100 ký tự").optional().nullable(),
  longevity: z.string().max(100, "Độ lưu hương không được vượt quá 100 ký tự").optional().nullable(),
})
  ...
  const onSubmit = async (values: ProductFormValues) => {
    try {
      ...
      const formattedValues = {
        ...
        perfume_type_id: values.perfume_type_id ? Number.parseInt(values.perfume_type_id) : null,
        concentration_id: values.concentration_id ? Number.parseInt(values.concentration_id) : null,
        release_year: values.release_year ? Number.parseInt(values.release_year) : null,
      }

      if (mode === "create") {
        // Create new product
        const result = await createProductMutation.mutateAsync(formattedValues)
        const newProductId = Array.isArray(result) && result.length > 0 ? result[0].id : null
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid grid-cols-5 mb-4">
            ...
            <TabsTrigger value="variants" disabled={mode === "create" && !createdProductId}>
              Biến thể
            </TabsTrigger>
            <TabsTrigger value="images" disabled={mode === "create" && !createdProductId}>
              Hình ảnh
            </TabsTrigger>
            <TabsTrigger value="categories" disabled={mode === "create" && !createdProductId}>
              Danh mục
            </TabsTrigger>
            <TabsTrigger value="ingredients" disabled={mode === "create" && !createdProductId}>
              Thành phần
            </TabsTrigger>
          </TabsList>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>Tên đầy đủ của sản phẩm.</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Nhập mã sản phẩm (tùy chọn)" {...field} value={field.value || ""} />
                        </FormControl>
                        <FormDescription>Mã sản phẩm nội bộ (nếu có).</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>Giới tính phù hợp với sản phẩm.</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>Loại nước hoa (Designer, Niche...).</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>Nồng độ của nước hoa (EDP, EDT...).</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Nhập xuất xứ (tùy chọn)" {...field} value={field.value || ""} />
                        </FormControl>
                        <FormDescription>Quốc gia xuất xứ của sản phẩm.</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>Năm phát hành sản phẩm.</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Nhập phong cách (tùy chọn)" {...field} value={field.value || ""} />
                        </FormControl>
                        <FormDescription>Phong cách của sản phẩm (Sang trọng, Quyến rũ...).</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Nhập độ tỏa hương (tùy chọn)" {...field} value={field.value || ""} />
                        </FormControl>
                        <FormDescription>Độ tỏa hương của sản phẩm (Gần, Vừa, Xa...).</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Nhập độ lưu hương (tùy chọn)" {...field} value={field.value || ""} />
                        </FormControl>
                        <FormDescription>Độ lưu hương của sản phẩm (Kém, Tốt, Rất tốt...).</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Mô tả ngắn gọn về sản phẩm (hiển thị ở trang danh sách).</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Mô tả chi tiết về sản phẩm (hiển thị ở trang chi tiết).</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                ...
                <DialogFooter>
                  ...
                  <Button type="submit" disabled={isProcessing}>
                    {isProcessing ? "Đang xử lý..." : mode === "create" ? "Tạo sản phẩm" : "Cập nhật sản phẩm"}
                  </Button>
                </DialogFooter>
              </form>
            </Form>
          ...
          <TabsContent value="ingredients" className="space-y-4 mt-4">
            <ProductIngredientsTab productId={createdProductId || product?.id} />
          </TabsContent>
        </Tabs>
      </DialogContent>
    </Dialog>
