...
import { ArrowUpRight, Package, ShoppingBag, Users, CreditCard, TrendingUp, Clock, AlertCircle } from "lucide-react"
    ...
    <AdminLayout>
      <div className="flex flex-col gap-6">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-muted-foreground">Đây là tổng quan về hoạt động của cửa hàng MyBeauty</p>
        </div>
        ...
        <Tabs defaultValue="overview" className="space-y-4">
                    ...
                    <div className="space-y-2">
                      {[
                        ...
                        <div key={order.id} className="grid grid-cols-4 items-center">
                          ...
                          <div className={order.statusColor}>{order.status}</div>
                          <div className="text-right">{formatCurrency(order.amount)}</div>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3 rounded-lg border p-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">12 sản phẩm có số lượng tồn kho dưới 5</p>
                    </div>
                  ...
                  <div className="flex items-center gap-3 rounded-lg border p-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">15 đơn hàng đang chờ xác nhận quá 24 giờ</p>
                    </div>
                    <Button size="sm">Xem chi tiết</Button>
                  </div>
                  <div className="flex items-center gap-3 rounded-lg border p-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">8 đánh giá mới đang chờ duyệt</p>
                    </div>
                    <Button size="sm">Xem chi tiết</Button>
                  </div>
                </div>
          ...
          <TabsContent value="analytics" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Phân tích dữ liệu bán hàng và hành vi người dùng</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Tính năng phân tích chi tiết đang được phát triển và sẽ sớm được cập nhật.
                </p>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="reports" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Tạo và xuất báo cáo theo nhiều tiêu chí khác nhau</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Tính năng báo cáo đang được phát triển và sẽ sớm được cập nhật.
                </p>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="notifications" className="space-y-4">
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Tính năng quản lý thông báo đang được phát triển và sẽ sớm được cập nhật.
                </p>
              </CardContent>
            </Card>
          </TabsContent>
