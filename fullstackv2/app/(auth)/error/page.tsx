      ...
      <div className="max-w-3xl w-full py-8 text-center">
        <div className="mb-8">
          ...
          <p className="mt-4 text-base text-muted-foreground">
            Authentication Failed. We couldn&#39;t verify your identity. Please check your credentials and try again. If
            the issue persists, ensure your verification link is valid or request a new one. Need help? Contact support.
          </p>
        </div>
