      ...
      <div className="w-full max-w-3xl py-8 text-center">
        <div className="mb-8">
          ...
          <p className="mt-4 text-base text-muted-foreground">
            Oops! Something went wrong. The page you’re looking for might have been moved, deleted, or temporarily
            unavailable. Please check the URL or return to the homepage. If the issue persists, contact support for
            assistance.
          </p>
        </div>
