...
import type { PostgrestFilterBuilder, PostgrestTransformBuilder, PostgrestSingleResponse } from "@supabase/postgrest-js"
...
>(
  ...
  queryOptions?: Omit<UseQueryOptions<FetchHookResult<TResult>, PostgrestError>, "queryKey" | "queryFn">,
) {
