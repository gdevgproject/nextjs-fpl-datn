    ...
    <section className="space-y-8">
      ...
      <div className="relative px-1 py-2">
        <div
          ...
          className="flex space-x-6 overflow-x-auto pb-8 pt-2 px-1 snap-x scrollbar-thin scrollbar-thumb-rounded scrollbar-thumb-primary/70 dark:scrollbar-thumb-secondary/70"
        >
            ...
            <button
              ...
              className={cn(
                ...
                selectedCategory?.id === category.id
                  ? "ring-2 ring-primary shadow-lg" // Ring outside with no offset
                  : "hover:scale-105 hover:shadow-md"
              )}
            >
              <Card className="overflow-hidden border-0 shadow-none bg-transparent m-0 p-0">
