...
const concentrationFormSchema = z.object({
  name: z
    .string()
    .min(1, "Tên nồng độ không được để trống")
    .max(100, "Tên nồng độ không được vượt quá 100 ký tự"),
  description: z
    .string()
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>
            {mode === "create" ? "Thêm nồng độ mới" : "Chỉnh sửa nồng độ"}
          </DialogTitle>
          <DialogDescription>
            {mode === "create"
              ? "Thêm một nồng độ mới vào hệ thống."
              : "Chỉnh sửa thông tin nồng độ."}
          </DialogDescription>
        </DialogHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Tên nồng độ phải là duy nhất trong hệ thống.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
