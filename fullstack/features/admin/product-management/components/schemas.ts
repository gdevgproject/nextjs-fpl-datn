...
export const productFormSchema = z.object({
  ...
  release_year: z.number().int("Năm phát hành phải là số nguyên").min(1900, "Năm phát hành không hợp lệ").max(new Date().getFullYear(), "Năm phát hành không được lớn hơn năm hiện tại").nullable().optional(),
